    ...
    return (
        <div className="flex flex-col items-center justify-start h-screen bg-gray-100 relative p-4">
            ...
            {isOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-sm">
                        <h2 className="text-xl font-semibold text-center text-gray-800 mb-4">{course.id ? 'Edit Course' : 'Add Course'}</h2>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 font-medium mb-1" htmlFor="duration">Duration (in hours):</label>
                                <input
                                    type="number"
                                    name="duration"
                                    id="duration"
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 font-medium mb-1" htmlFor="difficultyLevel">Difficulty Level:</label>
                                <select
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 font-medium mb-1" htmlFor="learningPathId">Learning Path:</label>
                                <select
                                    name="learningPathId"
                                    id="learningPathId"
                ...
                <table className="min-w-full border border-gray-300">
                    ...
                    <tbody>
                        ...
                        {currentCourses.length === 0 && (
                            <tr>
                                <td colSpan="3" className="text-center py-4">No courses found.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
            ...
            <div className="flex justify-between mt-4 w-full max-w-2xl">
                ...
                <span className="self-center">{`Page ${currentPage} of ${Math.ceil(courses.length / coursesPerPage)}`}</span>
                <button
